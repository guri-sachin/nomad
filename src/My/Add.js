...
function Admin(){
  ...
  function Saveproduct(e) {
    ...
    axios.post("http://localhost:4200/addsubscriptions",data).then(
        res=> console.log(res)
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputPrice" aria-describedby="pricelHelp" placeholder="Enter price" onChange={handelDemo5}/>
