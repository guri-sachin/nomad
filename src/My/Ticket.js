...
function Admin(){
  ...
  useEffect(()=>{
    axios.get("http://localhost:4200/listticket").then(res=>setProducts(res.data));
},[]);
  ...
  var data=  {"reply":reply,"id":id}
   ...
   axios.post("http://localhost:4200/reply",data).then(
         res=>  
      ...
      console.log(data)
        ...
        function Piya(e){
          ...
          axios.get(`http://localhost:4200/ticketdelete/${id}`).then(
