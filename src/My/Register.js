...
function Admin(){
  ...
  const [product,setProducts] =useState([]);
   useEffect(()=>{
    axios.post("http://localhost:4200/register").then(res=>setProducts(res.data));
},[]);
 ...
 function Piya(e){
  ...
  axios.get(`http://localhost:4200/redelete/${id}`).then(
...
async function Details(e){
  ...
  console.log(e.target.id)
   ...
   const response = await fetch("http://localhost:4200/listdetails",config);
