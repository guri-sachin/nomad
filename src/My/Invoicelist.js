...
function Admin() {
    ...
    useEffect(() => {
        axios.get("http://localhost:4200/listinvoice").then(res => setProducts(res.data));
    }, []);
    ...
    function Show3(e){
      ...
      console.log(e.target.name)
        ...
        axios.post(`http://localhost:4200/updateinvoice/${id}`,data).then(
          res=> console.log(res))
          console.log(id);
        console.log(data);
        Swal.fire({
  ...
  const response = await fetch("http://localhost:4200/listinvoiceon",config);
