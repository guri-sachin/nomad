...
function Admin(){
  ...
  useEffect(()=>{
    axios.get("http://localhost:4200/subscription").then(res=>setProducts(res.data));
},[]);
 ...
 function Piya(e){
  ...
  axios.get(`http://localhost:4200/subdelete/${id}`).then(
...
function onEdit(e){
  const id = e.target.id;
  axios.get(`http://localhost:4200/subedit/${id}`).then(
      res =>{
     var diojk =res.data 
                  ...
                  <table class="table align-items-center table-flush">
                    <thead class="thead-light" >
                      <tr>
                         ...
                         <th width="14%">Subscription Plan</th>
